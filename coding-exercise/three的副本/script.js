...
function inputHapppened(){
    ...
    console.log(volumeInput.value)
      ...
      TweenLite.to(cube, 0.1, {css:{rotationZ:volumeInput.value}});
    }
  range.addEventListener("input", inputHapppened)
  volumeRange.addEventListener("input", inputHapppened)
  //my working part 
...
//             TweenLite.to('.bottom', 0.3, {css:{rotationX:rotation+dataArray[i]}});
//             TweenLite.to(cube, 0.1, {css:{rotationX:dataArray[i]}});
//           }
//         }
